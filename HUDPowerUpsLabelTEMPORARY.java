 ...
 * @version 1.1
 */
public class HUDPowerUpsLabelTEMPORARY extends Actor
{
     ...
     */
    public HUDPowerUpsLabelTEMPORARY(int value, int fontSize)
    {
     ...
     */
    public HUDPowerUpsLabelTEMPORARY(String value, int fontSize)
    {
        this.value = value;
